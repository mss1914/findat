            ...
            for x in self.series_id:
                ...
                while True:
                    try:
                        ...
                        print('Unable to connect to FRED; trying again.')
                        time.sleep(10)
                        failloop += 1
                        if failloop > 3:
                            print('Unable to connect to FRED; Check '
                                  + 'your API key')
                            sys.exit()
...
def yahoo_sp(stock_symbol):
    ...
    if yahoo_url_text.find('Download to Spreadsheet') != -1:
        ...
        stock_df = pandas.DataFrame.from_csv(url_address, sep=',')
